package com.axisrooms.channelManagerUserModule.constants;
...
public final class FrameworkConstant {
	...
	private static final String EXCELFILEPATH = RESOURCESPATH + "/src/test/resources/excelFiles/TestData.xlsx";
